...
class PyBulletin2(QtWidgets.QMainWindow):
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(ui_utils.UI_PY_BULLETIN1366, self)
    ...
    def _timeout(self):
        ...
        self.ui.label_marquee.move(self.current_x, 10)
                    ...
                    <table width="98%" style="font-weight:bold; font-family:Microsoft JhengHei">
                        <thead>
                            <tr bgcolor="Navy" style="color: white">
                                <th style="font-size: 32px; font-weight: bold;"
                        ...
                        <tbody>
                            <tr bgcolor="LightCyan" style="color: red">
                                <td style="font-size: 96px; font-weight: bold" align="center">
                                    {called_regist_no}
                                </td>
                            </tr>
                        </tbody>
        ...
        for row_no, row in enumerate(waiting_rows):
            ...
            waiting_html += f"""
                <tr bgcolor="LightCyan" style="color: {color}">
                    <td style="font-size: 48px; font-weight: bold" align="center">
                        {regist_no}
                    </td>
                    <td style="font-size: 48px; font-weight: bold" align="center">
            ...
            <tr>
                <td>
                    <table width="98%" style="font-weight:bold; font-family:Microsoft JhengHei">
                        <thead>
                            <tr bgcolor="Navy" style="color: white">
                                <th width="40%" style="font-size: 32px; font-weight: bold;"
                                    text-align: center; padding-left: 8px>
                                    診號
                                </th>
                                <th style="font-size: 32px; font-weight: bold;"
