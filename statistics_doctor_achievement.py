...
class StatisticsDoctorAchievement(QtWidgets.QMainWindow):
    ...
    def _set_table_width(self):
        width = [
            100,
            130, 60, 70, 100, 60,
            70, 70, 70, 70, 70, 70, 70, 70, 70, 90, 70, 70, 90, 100,
        ]
    ...
    def _read_data(self):
        ...
        if self.doctor != '全部':
            ...
            doctor_condition = ' AND cases.Doctor IS NOT NULL AND LENGTH(cases.Doctor) > 0 '
    ...
    def _set_table_data(self, row_no, row):
        ...
        if self_drug_fee > 0 and self_treat_fee == 0 and self_drug_fee != total_fee:
        ...
        if self.ui.label_self_drug_rate_type.text() == '$':
            ...
            self_drug_fee_commission = number_utils.round_up_ex(self_drug_fee * self_drug_fee_rate / 100, '.1')
        ...
        for col_no in range(len(medical_record_row)):
            ...
            if col_no in [2, 3] or (col_no >= 6 and col_no <= 18):
    ...
    def _export_to_excel(self):
        ...
        export_utils.export_table_widget_to_excel(
            excel_file_name, self.ui.tableWidget_doctor_summary, [0], [2, 3, 6, 8, 9, 11, 12, 14, 15, 17, 18]
        )
