...
class RestoreMedicalRecords(QtWidgets.QMainWindow):
    ...
    def _set_signal(self):
        self.ui.tableWidget_medical_records.itemSelectionChanged.connect(
    ...
    def read_data(self):
        ...
        self.table_widget_medical_records.set_db_data(
            sql, self._set_medical_record_data
        )
    ...
    def restore_medical_record(self):
        ...
        self.ui.tableWidget_medical_records.setItem(
            row_no, 18, QtWidgets.QTableWidgetItem("是")
        )
        self.ui.tableWidget_medical_records.item(row_no, 18).setTextAlignment(
