...
class StatisticsDoctorMonthlyPersonCount(QtWidgets.QMainWindow):
    ...
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(
            ui_utils.UI_STATISTICS_DOCTOR_MONTHLY_PERSON_COUNT, self
        )
    ...
    def _set_calendar_heading(self):
        ...
        for row_no, case_date in enumerate(calendar_list):
            ...
            self.ui.tableWidget_person.item(row_no, 0).setTextAlignment(
                QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter
            )
            self.ui.tableWidget_person.item(row_no, 1).setTextAlignment(
                QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter
            )
    ...
    def _count_person(self, row, row_no):
        ...
        acupuncture_subtotal = (
            ...
            + highly_acupuncture
            + acupuncture_with_medicine
            + m_acupuncture_with_medicine
            + h_acupuncture_with_medicine
        )
        massage_subtotal = (
            general_massage + moderate_massage + highly_massage + massage_with_medicine
        )
        ...
        subtotal = (
            internal_medicine + acupuncture_subtotal + massage_subtotal + merge_subtotal
        )
    ...
    def _set_table_item(self, row_no, col_no, data):
        ...
        self.ui.tableWidget_person.item(row_no, col_no).setTextAlignment(
            QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter
        )
    ...
    def _calculate_total(self):
        ...
        self.ui.tableWidget_person.item(row_count - 1, 0).setTextAlignment(
            QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter
        )
