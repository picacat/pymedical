...
class StatisticsCommission(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None, *args):
        super(StatisticsCommission, self).__init__(parent)
        self.parent = parent
    ...
    def open_dialog(self):
        dialog = dialog_utils.get_dialog_statistics_therapist(
            self, self.database, self.system_settings, '醫師統計', '全部',
        )
    ...
    def _add_statistic_doctor_sale(self, start_date, end_date, period, doctor, option, weekday_list):
        self.tab_statistics_commission_sale = module_utils.get_statistics_commission_sale(
        ...
        self.ui.tabWidget_statistics_doctor.addTab(self.tab_statistics_commission_sale, '自費銷售抽成統計')
