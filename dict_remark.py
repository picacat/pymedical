...
class DictRemark(QtWidgets.QMainWindow):
    ...
    def _set_ui(self):
        ...
        self.table_widget_dict_remark = class_utils.get_table_widget(
            self.ui.tableWidget_dict_remark, self.database
        )
    ...
    def dict_groups_name_changed(self):
        ...
        self.ui.groupBox_dict_remark.setTitle(
    ...
    def _set_dict_remark_data(self, rec_no, rec):
        ...
        for column in range(len(dict_remark_rec)):
            self.ui.tableWidget_dict_remark.setItem(
                rec_no, column, QtWidgets.QTableWidgetItem(dict_remark_rec[column])
            )
    ...
    def _remove_remark(self):
        ...
        self.ui.tableWidget_dict_remark.removeRow(
            self.ui.tableWidget_dict_remark.currentRow()
        )
    ...
    def _edit_remark(self):
        ...
        self._set_dict_remark_data(
            self.ui.tableWidget_dict_remark.currentRow(), row_data
        )
