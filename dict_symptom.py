...
from libs import class_utils, dialog_utils, string_utils, system_utils, ui_utils
...
class DictSymptom(QtWidgets.QMainWindow):
    ...
    def _set_ui(self):
        ...
        self.table_widget_dict_symptom = class_utils.get_table_widget(
            self.ui.tableWidget_dict_symptom, self.database
        )
    ...
    def _set_signal(self):
        ...
        self.ui.tableWidget_dict_groups_name.itemSelectionChanged.connect(
        ...
        self.ui.tableWidget_dict_groups_name.doubleClicked.connect(
            self._edit_groups_name
        )
    ...
    def _search_symptom(self):
        ...
        while True:
            for row_no in range(
                self.ui.tableWidget_dict_symptom.currentRow() + 1,
            ...
            if current_groups_name >= self.ui.tableWidget_dict_groups_name.rowCount():
                ...
                self.ui.tableWidget_dict_groups_name.setCurrentCell(
                    current_groups_name, 1
                )
    ...
    def dict_groups_changed(self):
        ...
        self.ui.groupBox_dict_groups_name.setTitle(
            string_utils.xstr(dict_groups_type) + "類別"
        )
    ...
    def _read_dict_groups_name(self, dict_groups_type):
        ...
        '''
        self.table_widget_dict_groups_name.set_db_data(
            sql, self._set_dict_groups_name_data
        )
        self.dict_groups_name_changed()
    ...
    def _set_dict_groups_name_data(self, rec_no, rec):
        ...
        for column in range(len(dict_groups_name_rec)):
            self.ui.tableWidget_dict_groups_name.setItem(
                rec_no, column, QtWidgets.QTableWidgetItem(dict_groups_name_rec[column])
            )

    def dict_groups_name_changed(self):
        dict_groups_name = self.table_widget_dict_groups_name.field_value(1)
        self.ui.groupBox_dict_symptom.setTitle(
    ...
    def _set_dict_symptom_data(self, rec_no, rec):
        ...
        for column in range(len(dict_symptom_rec)):
            self.ui.tableWidget_dict_symptom.setItem(
                rec_no, column, QtWidgets.QTableWidgetItem(dict_symptom_rec[column])
            )
    ...
    def _edit_dict_groups(self):
        ...
        self.database.update_record(
            ...
            fields,
            "DictGroupsKey",
            self.table_widget_dict_groups.field_value(0),
            data,
        )
    ...
    def _add_groups_name(self):
        ...
        data = [self.dict_type, dict_groups, groups_name]
        self.database.insert_record("dict_groups", field, data)
    ...
    def _remove_groups_name(self):
        ...
        self.database.delete_record("dict_groups", "DictGroupsKey", key)
        self.ui.tableWidget_dict_groups_name.removeRow(
            self.ui.tableWidget_dict_groups_name.currentRow()
        )
    ...
    def _edit_groups_name(self):
        ...
        self.database.update_record(
            ...
            fields,
            "DictGroupsKey",
            self.table_widget_dict_groups_name.field_value(0),
            data,
        )
        self.ui.tableWidget_dict_groups_name.item(
            self.ui.tableWidget_dict_groups_name.currentRow(), 1
        ).setText(dict_groups_name)
    ...
    def _remove_symptom(self):
        ...
        self.ui.tableWidget_dict_symptom.removeRow(
            self.ui.tableWidget_dict_symptom.currentRow()
        )
    ...
    def _edit_symptom(self):
        ...
        """
        params = (clinic_key,)
        row_data = self.database.select_record(sql, params=params)
        if not row_data:
            return

        row_data = row_data[0]
        self._set_dict_symptom_data(
            self.ui.tableWidget_dict_symptom.currentRow(), row_data
        )
