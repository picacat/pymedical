...
# 診數統計 2021-09-27
class StatisticsPeriodCount(QtWidgets.QMainWindow):
    # 初始化
    def __init__(self, parent=None, *args):
        super(StatisticsPeriodCount, self).__init__(parent)
        self.parent = parent
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(ui_utils.UI_STATISTICS_PERIOD_COUNT, self)
    ...
    def _set_tab_widget(self, start_date, end_date, period, ins_type, doctor):
        ...
        self._add_statistic_doctor_period_count(start_date, end_date, ins_type, period, doctor)

    # 醫師診數統計
    def _add_statistic_doctor_period_count(self, start_date, end_date, ins_type, period, doctor):
        self.tab_statistics_doctor_period_count = module_utils.get_statistics_doctor_period_count(
            self, self.database, self.system_settings, start_date, end_date, ins_type, period, doctor)
        self.tab_statistics_doctor_period_count.start_calculate()
        self.ui.tabWidget_statistics_doctor.addTab(self.tab_statistics_doctor_period_count, '醫師診數統計')
