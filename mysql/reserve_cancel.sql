...
CREATE TABLE `reserve_cancel` (
  `ReserveCancelKey` int(11) NOT NULL AUTO_INCREMENT,
  `CancelDate` datetime NOT NULL,
  `ReserveKey` int(11) NOT NULL,
  `PatientKey` int(11) NOT NULL,
  `Name` varchar(100) DEFAULT NULL,
  `Source` varchar(10) DEFAULT NULL,
  `Remark` varchar(200) DEFAULT NULL,
  `ReserveBackup` mediumtext DEFAULT NULL,
  `TimeStamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`ReserveCancelKey`),
  KEY `CancelDate` (`CancelDate`,`ReserveKey`,`PatientKey`,`Source`)
