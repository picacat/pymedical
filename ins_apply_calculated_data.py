...
class InsApplyCalculatedData(QtWidgets.QMainWindow):
    ...
    def _calculate_total(self):
        ...
        diag_section1, diag_section2, diag_section3, diag_section4, diag_section5 = (
            0,
            0,
            0,
            0,
        ...
        for row_no in range(row_count):
            total_days += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 3).text()
            )
            total_count += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 4).text()
            )
            total_diag += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 5).text()
            )
            diag_count += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 6).text()
            )
            diag_section1 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 7).text()
            )
            diag_section2 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 8).text()
            )
            diag_section3 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 9).text()
            )
            diag_section4 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 10).text()
            )
            diag_section5 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 11).text()
            )
            treat_count += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 12).text()
            )
            treat_section1 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 13).text()
            )
            treat_section2 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 14).text()
            )
            treat_section3 += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 15).text()
            )
            internal_drug += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 16).text()
            )
            treat_drug += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 17).text()
            )
            total_drug += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 18).text()
            )
            complicated_massage += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 19).text()
            )
            ...
            infectious_count += number_utils.get_integer(
                self.ui.tableWidget_ins_apply_data.item(row_no, 22).text()
            )
    ...
    def _calculate_infectious_total(self):
        row_count = self.ui.tableWidget_ins_apply_data.rowCount()
        infectious_count = number_utils.get_integer(
            self.ui.tableWidget_ins_apply_data.item(row_count - 1, 22).text()
        )
    ...
    def _export_to_excel(self):
        ...
        export_utils.export_table_widget_to_excel(
            excel_file_name,
            self.ui.tableWidget_ins_apply_data,
            None,
