...
class PyBulletin7(QtWidgets.QMainWindow):
    ...
    def show_bulletin(self):
        ...
        self._show_pharmacy_list(blink=False)
        self._set_clock()
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(ui_utils.UI_PY_BULLETIN7, self)
    ...
    def _broadcast_speech(self, json_data):
        ...
        if "領藥" in sentence:
            drug_no = number_utils.get_integer(voice_dict.get("drug_no", 0))
    ...
    def _play_marquee(self):
        ...
        self.ui.label_marquee.move(self.current_x, MARQUEE_Y)
        self._set_timer()
    ...
    def _show_pharmacy_list(self, drug_no=0, blink=True):
        html = f"""
            <table border="0" width="100%"
                ...
                <tbody>
                    <tr>
                        <td width="15%" style="padding: 30px; font-size: 64px; font-weight: bold;
    ...
    def toggle_background(self):
        ...
        color = "Orange" if self.blink_state else self.color
        self.ui.label_drug_no.setStyleSheet(
...
def main():
    ...
    py_bulletin = PyBulletin7(None, sys.argv)
