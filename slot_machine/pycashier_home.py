...
class PyCashierHome(QtWidgets.QMainWindow):
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(ui_utils.UI_PYCASHIER_HOME, self)
        style = '''
            QMainWindow#WindowHome
            {border-image: url(./images/pycashier_home.jpg);}
        '''
        self.ui.setStyleSheet(style)
        self.ui.label_doctor1.move(120, 340)
        self.ui.label_doctor2.move(640, 340)
