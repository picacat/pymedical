# 收費設定 自費項目設定 2026.09.21
# -*- coding: UTF-8 -*-

from PyQt5 import QtWidgets

from libs import nhi_utils, system_utils, ui_utils
...
class DialogInputRegist(QtWidgets.QDialog):
    ...
    def _set_combo_box(self):
        ui_utils.set_combo_box(
            ...
            nhi_utils.INS_TYPE + ["備註", "自費折扣", "自費調理"],
            "不分類",
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_share_type, nhi_utils.SHARE_TYPE, "不分類"
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_treat_type, nhi_utils.TREAT_TYPE, "不分類"
        )
