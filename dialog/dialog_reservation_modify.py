...
from libs import alleypin_utils
from libs import hainachuan_utils
...
class DialogReservationModify(QtWidgets.QDialog):
    ...
    def _set_combo_box(self):
        ...
        ui_utils.set_combo_box(
            ...
            ['現場預約', '初診預約', '網路預約', '網路初診預約', '視訊預約', '視訊初診預約', '特殊預約'])
    ...
    def accepted_button_clicked(self):
        ...
        fields = [
            ...
            'Room', 'Doctor', 'Arrival', 'Source', 'Remark',
        ]
