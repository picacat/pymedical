...
class DialogSystemSettings(QtWidgets.QDialog):
    ...
    def _set_ui(self):
        ...
        self.table_widget_station_list = class_utils.get_table_widget(
            self.ui.tableWidget_station_list,
            self.database,
        )
        self.table_widget_start_no = class_utils.get_table_widget(
            self.ui.tableWidget_start_no,
            self.database,
        )
    ...
    def _set_signal(self):
        ...
        self.ui.toolButton_get_database_physical_dir.clicked.connect(
            self._get_database_physical_dir
        )
        ...
        self.ui.toolButton_electronic_prescript_path.clicked.connect(
            self._get_electronic_prescript_path
        )
        self.ui.toolButton_cashier_machine_path.clicked.connect(
            self._get_cashier_machine_path
        )
        self.ui.toolButton_blood_measure_path.clicked.connect(
            self._get_blood_measure_path
        )
        ...
        self.ui.tableWidget_start_no.itemSelectionChanged.connect(
            self._start_no_changed
        )
    ...
    def _set_combo_box(self):
        ui_utils.set_combo_box(self.ui.comboBox_theme, QtWidgets.QStyleFactory.keys())
        ...
        ui_utils.set_combo_box(
            self.ui.comboBox_color, ["紅色", "綠色", "藍色", "灰色", "自訂1"]
        )
        ...
        ui_utils.set_combo_box(
            self.ui.comboBox_ins_receipt_size_unit, ["英吋", "毫米"], "英吋"
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_ins_receipt_margin_unit, ["英吋", "毫米"], "毫米"
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_self_receipt_size_unit, ["英吋", "毫米"], "英吋"
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_self_receipt_margin_unit, ["英吋", "毫米"], "毫米"
        )
        ...
        ui_utils.set_combo_box(
            self.ui.comboBox_disease_group,
            ["常用病名", "所有病名", "自訂病名", "傷骨科"],
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_default_treat_type,
            ["內科", "一般針灸", "一般傷科"],
            "內科",
        )
    ...
    def _set_tour_combo_box(self):
        ...
        if (
            not self.ui.radioButton_reg_mountain.isChecked()
            and not self.ui.radioButton_reg_far.isChecked()
            and not self.ui.radioButton_reg_island.isChecked()
        ):
            return
    ...
    def _set_correction_combo_box(self):
        ...
        ui_utils.set_combo_box(
            self.ui.comboBox_correction_area, correction_area_list, current_text
        )
    ...
    def _set_combo_box_printer(self):
        ...
        ui_utils.set_combo_box(
            self.ui.comboBox_ins_prescript_printer, printer_list, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_self_prescript_printer, printer_list, None
        )
        ui_utils.set_combo_box(self.ui.comboBox_ins_receipt_printer, printer_list, None)
        ui_utils.set_combo_box(
            self.ui.comboBox_self_receipt_printer, printer_list, None
        )
        ...
        ui_utils.set_combo_box(
            self.ui.comboBox_report_printer_paper_size, printer_utils.PAPER_SIZE, None
        )
        ...
        ui_utils.set_combo_box(
            self.ui.comboBox_regist_form, printer_utils.PRINT_REGISTRATION_FORM, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_massage_form, printer_utils.PRINT_MASSAGE_FORM, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_reservation_form,
            printer_utils.PRINT_RESERVATION_FORM,
            None,
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_ins_prescript_form,
            printer_utils.PRINT_PRESCRIPTION_INS_FORM,
            None,
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_self_prescript_form,
            printer_utils.PRINT_PRESCRIPTION_SELF_FORM,
            None,
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_ins_receipt_form,
            printer_utils.PRINT_RECEIPT_INS_FORM,
            None,
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_self_receipt_form,
            printer_utils.PRINT_RECEIPT_SELF_FORM,
            None,
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_misc_form, printer_utils.PRINT_MISC_FORM, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_misc2_form, printer_utils.PRINT_MISC_FORM, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_misc3_form, printer_utils.PRINT_MISC_FORM, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_bag_form, printer_utils.PRINT_PRESCRIPTION_BAG_FORM, None
        )

        ui_utils.set_combo_box(self.ui.comboBox_regist_print_mode, print_mode, None)
        ui_utils.set_combo_box(
            self.ui.comboBox_reservation_print_mode, print_mode, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_ins_prescript_print_mode, print_mode, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_self_prescript_print_mode, print_mode, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_ins_receipt_print_mode, print_mode, None
        )
        ui_utils.set_combo_box(
            self.ui.comboBox_self_receipt_print_mode, print_mode, None
        )
        ui_utils.set_combo_box(self.ui.comboBox_bag_print_mode, print_mode, None)
        ui_utils.set_combo_box(
            self.ui.comboBox_massage_print_mode, printer_utils.PRINT_MODE2, None
        )
    ...
    def _read_clinic_settings(self):
        ...
        self.ui.spinBox_nurse.setValue(
            number_utils.get_integer(self.system_settings.field("護士人數"))
        )
        self.ui.spinBox_pharmacist.setValue(
            number_utils.get_integer(self.system_settings.field("藥師人數"))
        )
        ...
        self._set_check_box(
            self.ui.checkBox_new_clinic_smart_card, "新特約期間使用晶片讀卡機"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_pres_days_duplicated, "當日用藥重複檢查次日起算"
        )
        self._set_check_box(self.ui.checkBox_check_injury_period, "檢查損傷診斷碼")
        self._set_check_box(
            self.ui.checkBox_check_same_disease_pres_days, "檢查相同診斷碼用藥天數"
        )
        self._set_check_box(
            self.ui.checkBox_check_duplicate_2_days, "用藥重複二日不能存檔"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_no_convert_general_treat, "不要轉換一般針灸"
        )
        ...
        self.ui.spinBox_dosage_minimum2.setValue(
            number_utils.get_integer(self.system_settings.field("6歲以下最低劑量"))
        )
        ...
        self.ui.comboBox_tour_area.setCurrentText(
            self.system_settings.field("巡迴區域")
        )
        self.ui.comboBox_correction_area.setCurrentText(
            self.system_settings.field("矯正機關")
        )
        ...
        self._set_check_box(
            self.ui.checkBox_check_course_pres_days_once, "檢查療程開藥超過1次"
        )
        self._set_radio_button(
            [
        ...
        self.ui.lineEdit_exam_login_id.setText(
            self.system_settings.field("檢驗所用戶代碼")
        )
        self.ui.lineEdit_exam_login_pwd.setText(
            self.system_settings.field("檢驗所密碼")
        )

        self._set_check_box(self.ui.checkBox_course_disease, "療程不同病名不能存檔")
        self._set_check_box(
            self.ui.checkBox_medicine_duplicated, "開藥連續三次相同不能存檔"
        )
        self._set_check_box(self.ui.checkBox_medicine_two_times, "療程開藥兩次以上提醒")
        self._set_check_box(
            self.ui.checkBox_check_receipt_diag_share_fee, "檢查門診負擔多退少補"
        )
        ...
        self.ui.spinBox_moderate_acupuncture_time.setValue(
            number_utils.get_integer(
                self.system_settings.field("預設中度複雜性針灸治療時間")
            )
        )
        self.ui.spinBox_highly_acupuncture_time.setValue(
            number_utils.get_integer(
                self.system_settings.field("預設高度複雜性針灸治療時間")
            )
        )
        self.ui.spinBox_moderate_massage_time.setValue(
            number_utils.get_integer(
                self.system_settings.field("預設中度複雜性傷科治療時間")
            )
        )
        self.ui.spinBox_highly_massage_time.setValue(
            number_utils.get_integer(
                self.system_settings.field("預設高度複雜性傷科治療時間")
            )
        )
        ...
        self.ui.lineEdit_print_massage_address.setText(
            self.system_settings.field("民俗調理單地址")
        )
        self.ui.lineEdit_print_massage_remark.setText(
            self.system_settings.field("民俗調理單備註")
        )

        self.ui.lineEdit_vhc_token.setText(
            self.system_settings.field("虛擬健保卡授權憑證")
        )
    ...
    def _read_charge_settings(self):
        ...
        self._set_radio_button(
            [self.ui.radioButton_tail1, self.ui.radioButton_tail2],
            ["尾數為0", "尾數為0或5"],
            "自費折扣尾數",
        )
        self._set_radio_button(
        ...
        self._set_check_box(
            self.ui.checkBox_charge_done_allow, "所有資料都已批價才能結帳"
        )
        ...
        self.ui.comboBox_ins_diag_rate_type.setCurrentText(
            self.system_settings.field("診察費抽成類別")
        )
        self.ui.comboBox_ins_treat_rate_type.setCurrentText(
            self.system_settings.field("診察費抽成類別")
        )
        self.ui.comboBox_self_drug_rate_type.setCurrentText(
            self.system_settings.field("自費藥品抽成類別")
        )
        self.ui.comboBox_self_treat_rate_type.setCurrentText(
            self.system_settings.field("自費針傷抽成類別")
        )
        self.ui.lineEdit_tc_massage_field_name.setText(
            self.system_settings.field("民俗調理欄位名稱")
        )
    ...
    def _read_regist_no_settings(self):
        ...
        self.ui.spinBox_start_no1.setValue(
            number_utils.get_integer(self.system_settings.field("早班起始號"))
        )
        self.ui.spinBox_start_no2.setValue(
            number_utils.get_integer(self.system_settings.field("午班起始號"))
        )
        self.ui.spinBox_start_no3.setValue(
            number_utils.get_integer(self.system_settings.field("晚班起始號"))
        )
        self.ui.spinBox_start_drug_no.setValue(
            number_utils.get_integer(self.system_settings.field("領藥起始號"))
        )
        max_regist_no = number_utils.get_integer(
            self.system_settings.field("診號累加器最大號")
        )
        if max_regist_no == 0:
            max_regist_no = 9999
        ...
        self._set_check_box(
            self.ui.checkBox_reservation_table_no_time, "預約班表不顯示時間"
        )
        self._set_check_box(
            self.ui.checkBox_reservation_current_doctor, "預約選擇當診醫師"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_reserve_doctor_limit, "預約次數不同醫師分別計算"
        )
        self._set_check_box(self.ui.checkBox_reserve_allow_today, "開放當日網路預約")
        self._set_check_box(
            self.ui.checkBox_cancel_reserve_today, "當日可以取消網路預約"
        )
        self._set_check_box(
            self.ui.checkBox_no_waiting_progress, "網路預約不顯示看診進度"
        )
        self._set_check_box(self.ui.checkBox_no_waiting_count, "網路預約不顯示候診人數")
        ...
        self.ui.spinBox_no_return_days.setValue(
            number_utils.get_integer(self.system_settings.field("未回診天數"))
        )
    ...
    def _read_start_no(self):
        ...
        for row_no, row in enumerate(rows):
            ...
            self.ui.tableWidget_start_no.setRowCount(
                self.ui.tableWidget_start_no.rowCount() + 1
            )
            start_no_data = [
                room,
                start_no_dict["早班"],
    ...
    def _read_registration_settings(self):
        self._set_radio_button(
            [self.ui.radioButton_ins, self.ui.radioButton_self],
            ["健保", "自費"],
            "預設門診類別",
        )
        self._set_radio_button(
            [self.ui.radioButton_multi_sales, self.ui.radioButton_single_sales],
            ["複選", "單選"],
            "自購藥銷售人員",
        )
        self.ui.spinBox_diag_count.setValue(
            number_utils.get_integer(self.system_settings.field("首次警告次數"))
        )
        self.ui.spinBox_treat_count.setValue(
            number_utils.get_integer(self.system_settings.field("針傷警告次數"))
        )
        ...
        self._set_check_box(
            self.ui.checkBox_display_self_massage, "候診名單顯示自費民俗調理"
        )
        self._set_radio_button(
            [
        ...
        self._set_check_box(
            self.ui.checkBox_register_current_doctor, "掛號選擇當診醫師"
        )
        self._set_check_box(self.ui.checkBox_day14, "掛號療程14日未完成提醒")
        self._set_check_box(self.ui.checkBox_interrupt_course, "療程中斷不續療程")
        self._set_check_box(
            self.ui.checkBox_past_history_show_symptom, "掛號過去病歷顯示主訴"
        )
        self._set_check_box(
            self.ui.checkBox_past_history_show_massage, "掛號過去病歷顯示民俗調理"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_auto_last_treat_type, "掛號新療程自動帶出上次就醫類別"
        )
        self._set_check_box(self.ui.checkBox_debt_stop_regist, "欠款未還不能掛號")
        self._set_check_box(
            self.ui.checkBox_show_purchase_case, "掛號已就診名單顯示自購藥病歷"
        )
    ...
    def _read_doctor_settings(self):
        self.ui.spinBox_room.setValue(
            number_utils.get_integer(self.system_settings.field("診療室"))
        )
        self.ui.spinBox_count_per_page.setValue(
            number_utils.get_integer(self.system_settings.field("過去病歷一頁筆數"))
        )
        self.ui.comboBox_medical_record_page.setCurrentText(
            self.system_settings.field("病歷版面")
        )
        self.ui.comboBox_disease_layout.setCurrentText(
            self.system_settings.field("病名版面")
        )
        self.ui.comboBox_led_port.setCurrentText(
            self.system_settings.field("叫號燈連接埠")
        )
        self.ui.comboBox_scale_port.setCurrentText(
            self.system_settings.field("電子秤連接埠")
        )
        ...
        self._set_check_box(
            self.ui.checkBox_no_patient_remark, "病歷資料不顯示病患備註"
        )
        self._set_check_box(self.ui.checkBox_copy_self_prescript, "預設拷貝自費處方")
        self._set_check_box(
            self.ui.checkBox_copy_ins_past_medicine, "預設拷貝健保針傷科處方用藥"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_hit_rate_by_medicine_type, "處方點擊率依照處方類別排序"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_hide_reserve_time, "醫師候診名單隱藏預約時間"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_fixed_waiting_list_width, "醫師候診名單欄位固定寬度"
        )
        self._set_check_box(self.ui.checkBox_same_doctor, "病歷存檔檢查醫師姓名")
        self._set_check_box(self.ui.checkBox_check_fees, "病歷存檔檢查補退掛號費用")
        self._set_check_box(
            self.ui.checkBox_no_location_light_color, "處方無存放位置淡色顯示"
        )
        self._set_check_box(
            self.ui.checkBox_display_ins_drug, "健保處方詞庫只顯示單方複方"
        )
        self._set_check_box(
            self.ui.checkBox_no_instruction_pres_days, "單一處方服法不可取代用藥天數"
        )
        self._set_check_box(
            self.ui.checkBox_no_insufficent_medicine, "庫存量不足不要提醒"
        )
        self._set_check_box(
            self.ui.checkBox_no_deactivate_medicine, "不要顯示停用的藥品"
        )
        self._set_check_box(self.ui.checkBox_no_zero_price, "單日計價輸入藥品不要歸零")
        self._set_check_box(
            self.ui.checkBox_no_complicated_treat_dialog,
            "輸入病名後不要彈出複雜性針傷提示視窗",
        )
        self._set_check_box(
            self.ui.checkBox_reservation_current_period,
            "醫師候診名單只顯示當班預約資料",
        )
        ...
        self.ui.comboBox_default_treat_type.setCurrentText(
            self.system_settings.field("預設就醫類別")
        )

        self.ui.spinBox_packages.setValue(
            number_utils.get_integer(self.system_settings.field("給藥包數"))
        )
        self.ui.spinBox_days.setValue(
            number_utils.get_integer(self.system_settings.field("給藥天數"))
        )
        self.ui.comboBox_instruction.setCurrentText(
            self.system_settings.field("用藥指示")
        )
        self._set_radio_button(
            [
                self.ui.radioButton_dosage1,
        ...
        self._set_radio_button(
            [self.ui.radioButton_auto_chart_no1, self.ui.radioButton_auto_chart_no2],
            ["無", "身份證後四碼"],
            "自動產生病歷號",
        )
        self._set_radio_button(
            [
                self.ui.radioButton_self_room,
        ...
        self._set_radio_button(
            [self.ui.radioButton_order_no, self.ui.radioButton_order_time],
            ["診號排序", "時間排序"],
            "看診排序",
        )
        self._set_radio_button(
            [
                self.ui.radioButton_order_medicine_key,
        ...
        self._set_radio_button(
            [
                self.ui.radioButton_by_dict_name,
        ...
        self._set_radio_button(
            [
                self.ui.radioButton_by_diag_name,
        ...
        self._set_radio_button(
            [self.ui.radioButton_normal_price, self.ui.radioButton_single_day_price],
            ["正常計價", "單日計價"],
            "自費處方預設計價方式",
        )
        self._set_radio_button(
            [self.ui.radioButton_input_dosage, self.ui.radioButton_save_dosage],
            ["輸入處方時檢查", "存檔時檢查"],
            "健保處方給藥劑量上限檢查時機",
        )
        self._set_radio_button(
            [self.ui.radioButton_input_costs, self.ui.radioButton_save_costs],
            ["輸入處方時檢查", "存檔時檢查"],
            "健保用藥成本上限檢查時機",
        )
        self._set_radio_button(
            [self.ui.radioButton_normal_view, self.ui.radioButton_simple_view],
            ["詳細檢視", "精簡檢視"],
            "病歷查詢檢視方式",
        )
    ...
    def _read_printer_settings(self):
        self.ui.comboBox_regist_print_mode.setCurrentText(
            self.system_settings.field("列印門診掛號單")
        )
        self.ui.comboBox_reservation_print_mode.setCurrentText(
            self.system_settings.field("列印預約掛號單")
        )
        self.ui.comboBox_ins_prescript_print_mode.setCurrentText(
            self.system_settings.field("列印健保處方箋")
        )
        self.ui.comboBox_self_prescript_print_mode.setCurrentText(
            self.system_settings.field("列印自費處方箋")
        )
        self.ui.comboBox_ins_receipt_print_mode.setCurrentText(
            self.system_settings.field("列印健保醫療收據")
        )
        self.ui.comboBox_self_receipt_print_mode.setCurrentText(
            self.system_settings.field("列印自費醫療收據")
        )
        self.ui.comboBox_bag_print_mode.setCurrentText(
            self.system_settings.field("列印藥袋")
        )
        self.ui.comboBox_massage_print_mode.setCurrentText(
            self.system_settings.field("列印民俗調理單")
        )
        self.ui.comboBox_misc_print_mode.setCurrentText(
            self.system_settings.field("列印其他收據")
        )
        self.ui.comboBox_misc2_print_mode.setCurrentText(
            self.system_settings.field("列印其他收據2")
        )
        self.ui.comboBox_misc3_print_mode.setCurrentText(
            self.system_settings.field("列印其他收據3")
        )

        self.ui.comboBox_regist_form.setCurrentText(
            self.system_settings.field("門診掛號單格式")
        )
        self.ui.comboBox_reservation_form.setCurrentText(
            self.system_settings.field("預約掛號單格式")
        )
        self.ui.comboBox_ins_prescript_form.setCurrentText(
            self.system_settings.field("健保處方箋格式")
        )
        self.ui.comboBox_self_prescript_form.setCurrentText(
            self.system_settings.field("自費處方箋格式")
        )
        self.ui.comboBox_ins_receipt_form.setCurrentText(
            self.system_settings.field("健保醫療收據格式")
        )
        self.ui.comboBox_self_receipt_form.setCurrentText(
            self.system_settings.field("自費醫療收據格式")
        )
        self.ui.comboBox_bag_form.setCurrentText(self.system_settings.field("藥袋格式"))
        self.ui.comboBox_massage_form.setCurrentText(
            self.system_settings.field("民俗調理單格式")
        )
        self.ui.comboBox_misc_form.setCurrentText(
            self.system_settings.field("其他收據格式")
        )
        self.ui.comboBox_misc2_form.setCurrentText(
            self.system_settings.field("其他收據2格式")
        )
        self.ui.comboBox_misc3_form.setCurrentText(
            self.system_settings.field("其他收據3格式")
        )

        self.ui.comboBox_regist_printer.setCurrentText(
            self.system_settings.field("門診掛號單印表機")
        )
        self.ui.comboBox_reservation_printer.setCurrentText(
            self.system_settings.field("預約掛號單印表機")
        )
        self.ui.comboBox_ins_prescript_printer.setCurrentText(
            self.system_settings.field("健保處方箋印表機")
        )
        self.ui.comboBox_self_prescript_printer.setCurrentText(
            self.system_settings.field("自費處方箋印表機")
        )
        self.ui.comboBox_ins_receipt_printer.setCurrentText(
            self.system_settings.field("健保醫療收據印表機")
        )
        self.ui.comboBox_self_receipt_printer.setCurrentText(
            self.system_settings.field("自費醫療收據印表機")
        )
        self.ui.comboBox_bag_printer.setCurrentText(
            self.system_settings.field("藥袋印表機")
        )
        self.ui.comboBox_massage_printer.setCurrentText(
            self.system_settings.field("民俗調理單印表機")
        )
        self.ui.comboBox_massage_printer2.setCurrentText(
            self.system_settings.field("民俗調理單印表機2")
        )
        self.ui.comboBox_misc_printer.setCurrentText(
            self.system_settings.field("其他收據印表機")
        )
        self.ui.comboBox_misc2_printer.setCurrentText(
            self.system_settings.field("其他收據2印表機")
        )
        self.ui.comboBox_misc3_printer.setCurrentText(
            self.system_settings.field("其他收據3印表機")
        )

        self.ui.comboBox_report_print_mode.setCurrentText(
            self.system_settings.field("列印報表")
        )
        self.ui.comboBox_report_printer.setCurrentText(
            self.system_settings.field("報表印表機")
        )
        self.ui.comboBox_report_printer_paper_size.setCurrentText(
            self.system_settings.field("報表印表機紙張大小")
        )

        self.ui.lineEdit_certificate_payment_title.setText(
            self.system_settings.field("醫療費用證明書抬頭")
        )
        self.ui.lineEdit_folk_massage_name.setText(
            self.system_settings.field("民俗調理項目名稱")
        )
        self.ui.lineEdit_folk_massage_title.setText(
            self.system_settings.field("民俗調理收據抬頭")
        )
        self.ui.lineEdit_medicine_fee_field_name.setText(
            self.system_settings.field("醫療費用證明自費藥費欄位名稱")
        )
        self.ui.lineEdit_treat_fee_field_name.setText(
            self.system_settings.field("醫療費用證明自費處置欄位名稱")
        )
        self.ui.lineEdit_misc_fee_field_name.setText(
            self.system_settings.field("醫療費用證明其他費用欄位名稱")
        )
        self.ui.lineEdit_total_fee_field_name.setText(
            self.system_settings.field("醫療費用證明自費金額欄位名稱")
        )
        self.ui.lineEdit_total_fee_field_name2.setText(
            self.system_settings.field("醫療費用自付明細自費金額欄位名稱")
        )
        self.ui.plainTextEdit_tax_remark.setPlainText(
            self.system_settings.field("醫療費用收據自訂報稅備註")
        )
        ...
        self.ui.lineEdit_custom_clinic_name.setText(
            self.system_settings.field("自訂院所名稱")
        )
        ...
        self._set_check_box(
            self.ui.checkBox_location_before_medicine, "列印藥品存放位置在處方名稱前面"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_print_regist_non_zero, "掛號收據無金額不列印"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_print_no_treat_fee, "費用總表合併處置費至藥費"
        )
        ...
        self._set_check_box(
            self.ui.checkBox_self_prescript_package_dosage, "自費處方次劑量"
        )
        self._set_check_box(
        ...
        self._set_check_box(
            self.ui.checkBox_print_symptom_limitation, "列印主訴字數限制"
        )
        self._set_check_box(
            self.ui.checkBox_print_medicine_limitation, "列印處方字數限制"
        )
        self._set_check_box(self.ui.checkBox_self_daily_dosage, "自費收據列印日量")
        self._set_check_box(
            self.ui.checkBox_print_prescript_total_dosage, "處方箋列印總量"
        )
        self._set_check_box(
            self.ui.checkBox_ins_receipt, "健保費用收據同時輸出至掛號印表機"
        )
        self._set_check_box(
            self.ui.checkBox_self_receipt, "自費費用收據同時輸出至掛號印表機"
        )
        self._set_check_box(self.ui.checkBox_print_registration, "加印一張掛號單")

        self._set_check_box(
            self.ui.groupBox_ins_receipt_size, "自訂健保醫療收據尺寸邊界"
        )
        self._set_check_box(
            self.ui.groupBox_self_receipt_size, "自訂自費醫療收據尺寸邊界"
        )
        ...
        self.ui.comboBox_ins_receipt_size_unit.setCurrentText(
            self.system_settings.field("健保醫療收據尺寸單位")
        )
        self.ui.comboBox_self_receipt_size_unit.setCurrentText(
            self.system_settings.field("自費醫療收據尺寸單位")
        )
        ...
        self.ui.spinBox_symptom_count.setValue(
            number_utils.get_integer(self.system_settings.field("列印主訴字數"))
        )
        ...
        self._set_radio_button(
            [
                self.ui.radioButton_print_order1,
                self.ui.radioButton_print_order2,
                self.ui.radioButton_print_order3,
            ],
            ["列印順序1", "列印順序2", "列印順序3"],
            "病歷存檔列印順序",
        )
        ...
        self._set_check_box(
            self.ui.checkBox_print_each_self_fee, "列印所有收費收據各自金額"
        )
        self._set_check_box(self.ui.checkBox_print_bg_color, "列印報表雙色印刷")
        self._set_check_box(
            self.ui.checkBox_print_no_dosage_receipt, "自費加印無劑量收據"
        )

        self.ui.spinBox_prescript_font_size.setValue(
            number_utils.get_integer(
                self.system_settings.field("費用收據處方欄字體大小")
            )
        )
    ...
    def _read_reader_settings(self):
        ...
        self._set_radio_button(
            [
                self.ui.radioButton_smart_card_reader,
        ...
        self._set_radio_button(
            [self.ui.radioButton_cshis5, self.ui.radioButton_cshis6],
            ["cshis5", "cshis6"],
            "讀卡機控制軟體版本",
        )
        ...
        self._set_radio_button(
            [self.ui.radioButton_regist_secure, self.ui.radioButton_doctor_secure],
            ["掛號", "診療"],
            "產生安全簽章位置",
        )
        self._set_radio_button(
            [
                self.ui.radioButton_doctor_write,
        ...
        self._set_check_box(
            self.ui.checkBox_vhc_card_operation, "虛擬健保卡統一在掛號作業"
        )
    ...
    def _get_css_font_size(self):
        css_file = os.path.join(
            system_utils.BASE_DIR,
            system_utils.CSS_PATH,
            system_utils.get_css_file(self.system_settings),
        )
    ...
    def _read_misc(self):
        self.ui.spinBox_station_no.setValue(
            number_utils.get_integer(self.system_settings.field("工作站編號"))
        )
        ...
        self.ui.lineEdit_emr_path.setText(
            self.system_settings.field("電子病歷交換檔輸出路徑")
        )
        self.ui.lineEdit_clinic_dir.setText(self.system_settings.field("資料路徑"))
        self.ui.lineEdit_external_backup_dir.setText(
            self.system_settings.field("異地備份路徑")
        )
        self.ui.lineEdit_database_physical_dir.setText(
            self.system_settings.field("伺服器物理備份路徑")
        )
        self.ui.lineEdit_database_dir.setText(
            self.system_settings.field("伺服器資料來源")
        )
        self.ui.lineEdit_image_path.setText(self.system_settings.field("影像檔路徑"))
        self.ui.lineEdit_electronic_prescript_path.setText(
            self.system_settings.field("電子處方箋路徑")
        )
        self.ui.lineEdit_cashier_machine_path.setText(
            self.system_settings.field("掛號機錢箱路徑")
        )
        self.ui.lineEdit_blood_measure_path.setText(
            self.system_settings.field("血壓計路徑")
        )
        self._set_check_box(self.ui.checkBox_side_bar, "顯示側邊欄")
        self._set_check_box(self.ui.checkBox_font_weight, "粗體字")
        self._set_check_box(
            self.ui.checkBox_do_not_display_bulletin, "不要顯示最新消息"
        )
        self._set_check_box(self.ui.checkBox_self_emr, "匯出電子病歷包含自費病歷")
        self._set_check_box(self.ui.checkBox_use_docker, "使用docker")
        self._set_radio_button(
            [self.ui.radioButton_single_instance, self.ui.radioButton_multi_instance],
            ["獨立執行", "多個執行"],
            "醫療系統執行個體",
        )
        self._set_radio_button(
            [self.ui.radioButton_real_time_stock, self.ui.radioButton_batch_stock],
            ["即時調整", "批次調整"],
            "調整庫存量",
        )
        ...
        self._set_check_box(
            self.ui.checkBox_sync_in_price, "輸入進貨資料同步更新藥品進價"
        )

        self.ui.lineEdit_archive_database_name.setText(
            self.system_settings.field("封存資料庫名稱")
        )
        self.ui.lineEdit_voice_call_format.setText(
            self.system_settings.field("自訂叫號格式")
        )
    ...
    def _save_clinic_settings(self):
        ...
        self.system_settings.post(
            "6歲以下最低劑量", self.ui.spinBox_dosage_minimum2.value()
        )
        self.system_settings.post(
            "預設空白自費頁", self.ui.spinBox_default_self_prescript_tab.value()
        )

        self.system_settings.post(
            "健保用藥成本上限", self.ui.spinBox_ins_drug_fee_limitation.value()
        )
        self.system_settings.post(
            "病歷查詢一頁筆數", self.ui.spinBox_case_page_count.value()
        )
        ...
        self.system_settings.post(
            "矯正機關", self.ui.comboBox_correction_area.currentText()
        )
        ...
        self.system_settings.post(
            "檢驗所用戶代碼", self.ui.lineEdit_exam_login_id.text()
        )
        ...
        self._save_check_box(
            self.ui.checkBox_medicine_two_times, "療程開藥兩次以上提醒"
        )
        self._save_check_box(
            self.ui.checkBox_check_receipt_diag_share_fee, "檢查門診負擔多退少補"
        )
        ...
        self.system_settings.post(
            "預設中度複雜性針灸治療時間",
            self.ui.spinBox_moderate_acupuncture_time.value(),
        )
        self.system_settings.post(
            "預設高度複雜性針灸治療時間",
            self.ui.spinBox_highly_acupuncture_time.value(),
        )
        self.system_settings.post(
            "預設中度複雜性傷科治療時間", self.ui.spinBox_moderate_massage_time.value()
        )
        self.system_settings.post(
            "預設高度複雜性傷科治療時間", self.ui.spinBox_highly_massage_time.value()
        )
        self.system_settings.post(
            "最少針灸穴道數", self.ui.spinBox_min_acupuncture_points.value()
        )

        self.system_settings.post(
            "民俗調理單地址", self.ui.lineEdit_print_massage_address.text()
        )
        self.system_settings.post(
            "民俗調理單備註", self.ui.lineEdit_print_massage_remark.text()
        )
        self.system_settings.post(
            "虛擬健保卡授權憑證", self.ui.lineEdit_vhc_token.text()
        )
    ...
    def _save_charge_settings(self):
        ...
        self.system_settings.post(
            "診察費抽成類別", self.ui.comboBox_ins_diag_rate_type.currentText()
        )
        self.system_settings.post(
            "診療費抽成類別", self.ui.comboBox_ins_treat_rate_type.currentText()
        )
        self.system_settings.post(
            "自費藥品抽成類別", self.ui.comboBox_self_drug_rate_type.currentText()
        )
        self.system_settings.post(
            "自費針傷抽成類別", self.ui.comboBox_self_treat_rate_type.currentText()
        )
        self.system_settings.post(
            "民俗調理欄位名稱", self.ui.lineEdit_tc_massage_field_name.text()
        )
    ...
    def _save_regist_no_settings(self):
        ...
        self.system_settings.post(
            "診號累加器最大號", self.ui.spinBox_max_regist_no.value()
        )
        self._save_radio_button(
            [
                self.ui.radioButton_consecutive,
        ...
        self._save_check_box(
            self.ui.checkBox_no_waiting_count, "網路預約不顯示候診人數"
        )
        ...
        self.system_settings.post(
            "爽約期間", self.ui.spinBox_reservation_period.value()
        )
    ...
    def _save_start_no(self):
        ...
        self.database.exec_sql(
            f'DELETE FROM system_settings WHERE Field LIKE "{keyword}-%"'
        )
    ...
    def _save_notice(self):
        self.database.exec_sql(
            'DELETE FROM case_extension WHERE ExtensionType = "網站注意事項"'
        )
        ...
        for row_no in range(row_count):
            ...
            self.database.insert_record(
                "case_extension", fields, [0, "網站注意事項", content]
            )
    ...
    def _save_registration_settings(self):
        ...
        self._save_check_box(
            self.ui.checkBox_no_regist_no_duplicate, "掛號診號不可重複"
        )
        self._save_check_box(
            self.ui.checkBox_regist_visit_count, "掛號作業顯示初診統計"
        )
        self._save_check_box(
            self.ui.checkBox_auto_last_treat_type, "掛號新療程自動帶出上次就醫類別"
        )
        ...
        self._save_check_box(
            self.ui.checkBox_show_massage_fee, "掛號名單顯示民俗調理費"
        )
        self._save_check_box(
            self.ui.checkBox_no_change_doctor, "掛號診別更改不要連動醫師姓名"
        )
    ...
    def _save_doctor_settings(self):
        ...
        self.system_settings.post(
            "過去病歷一頁筆數", self.ui.spinBox_count_per_page.value()
        )
        self.system_settings.post(
            "病歷版面", self.ui.comboBox_medical_record_page.currentText()
        )
        self.system_settings.post(
            "病名版面", self.ui.comboBox_disease_layout.currentText()
        )
        self._save_check_box(self.ui.checkBox_copy_past, "自動顯示過去病歷")
        self._save_check_box(
            self.ui.checkBox_only_symptom, "過去病歷診察資料只顯示主訴"
        )
        self._save_check_box(
            self.ui.checkBox_no_patient_remark, "病歷資料不顯示病患備註"
        )
        ...
        self._save_check_box(
            self.ui.checkBox_display_custom, "健保處方詞庫顯示自訂類別"
        )
        ...
        self._save_check_box(
            self.ui.checkBox_hide_wait_time, "醫師候診名單隱藏候診時間"
        )
    ...
    def _save_printer_settings(self):
        self.system_settings.post(
            "列印門診掛號單", self.ui.comboBox_regist_print_mode.currentText()
        )
        self.system_settings.post(
            "列印預約掛號單", self.ui.comboBox_reservation_print_mode.currentText()
        )
        self.system_settings.post(
            "列印健保處方箋", self.ui.comboBox_ins_prescript_print_mode.currentText()
        )
        self.system_settings.post(
            "列印自費處方箋", self.ui.comboBox_self_prescript_print_mode.currentText()
        )
        self.system_settings.post(
            "列印健保醫療收據", self.ui.comboBox_ins_receipt_print_mode.currentText()
        )
        self.system_settings.post(
            "列印自費醫療收據", self.ui.comboBox_self_receipt_print_mode.currentText()
        )
        self.system_settings.post(
            "列印藥袋", self.ui.comboBox_bag_print_mode.currentText()
        )
        self.system_settings.post(
            "列印民俗調理單", self.ui.comboBox_massage_print_mode.currentText()
        )
        self.system_settings.post(
            "列印其他收據", self.ui.comboBox_misc_print_mode.currentText()
        )
        self.system_settings.post(
            "列印其他收據2", self.ui.comboBox_misc2_print_mode.currentText()
        )
        self.system_settings.post(
            "列印其他收據3", self.ui.comboBox_misc3_print_mode.currentText()
        )

        self.system_settings.post(
            "門診掛號單格式", self.ui.comboBox_regist_form.currentText()
        )
        self.system_settings.post(
            "預約掛號單格式", self.ui.comboBox_reservation_form.currentText()
        )
        self.system_settings.post(
            "健保處方箋格式", self.ui.comboBox_ins_prescript_form.currentText()
        )
        self.system_settings.post(
            "自費處方箋格式", self.ui.comboBox_self_prescript_form.currentText()
        )
        self.system_settings.post(
            "健保醫療收據格式", self.ui.comboBox_ins_receipt_form.currentText()
        )
        self.system_settings.post(
            "自費醫療收據格式", self.ui.comboBox_self_receipt_form.currentText()
        )
        self.system_settings.post("藥袋格式", self.ui.comboBox_bag_form.currentText())
        self.system_settings.post(
            "民俗調理單格式", self.ui.comboBox_massage_form.currentText()
        )
        self.system_settings.post(
            "其他收據格式", self.ui.comboBox_misc_form.currentText()
        )
        self.system_settings.post(
            "其他收據2格式", self.ui.comboBox_misc2_form.currentText()
        )
        self.system_settings.post(
            "其他收據3格式", self.ui.comboBox_misc3_form.currentText()
        )

        self.system_settings.post(
            "門診掛號單印表機", self.ui.comboBox_regist_printer.currentText()
        )
        self.system_settings.post(
            "預約掛號單印表機", self.ui.comboBox_reservation_printer.currentText()
        )
        self.system_settings.post(
            "健保處方箋印表機", self.ui.comboBox_ins_prescript_printer.currentText()
        )
        self.system_settings.post(
            "自費處方箋印表機", self.ui.comboBox_self_prescript_printer.currentText()
        )
        self.system_settings.post(
            "健保醫療收據印表機", self.ui.comboBox_ins_receipt_printer.currentText()
        )
        self.system_settings.post(
            "自費醫療收據印表機", self.ui.comboBox_self_receipt_printer.currentText()
        )
        self.system_settings.post(
            "藥袋印表機", self.ui.comboBox_bag_printer.currentText()
        )
        self.system_settings.post(
            "民俗調理單印表機", self.ui.comboBox_massage_printer.currentText()
        )
        self.system_settings.post(
            "民俗調理單印表機2", self.ui.comboBox_massage_printer2.currentText()
        )
        self.system_settings.post(
            "其他收據印表機", self.ui.comboBox_misc_printer.currentText()
        )
        self.system_settings.post(
            "其他收據2印表機", self.ui.comboBox_misc2_printer.currentText()
        )
        self.system_settings.post(
            "其他收據3印表機", self.ui.comboBox_misc3_printer.currentText()
        )

        self.system_settings.post(
            "列印報表", self.ui.comboBox_report_print_mode.currentText()
        )
        self.system_settings.post(
            "報表印表機", self.ui.comboBox_report_printer.currentText()
        )
        self.system_settings.post(
            "報表印表機紙張大小",
            self.ui.comboBox_report_printer_paper_size.currentText(),
        )

        self.system_settings.post(
            "醫療費用證明書抬頭", self.ui.lineEdit_certificate_payment_title.text()
        )
        self.system_settings.post(
            "民俗調理項目名稱", self.ui.lineEdit_folk_massage_name.text()
        )
        self.system_settings.post(
            "民俗調理收據抬頭", self.ui.lineEdit_folk_massage_title.text()
        )
        self.system_settings.post(
            "醫療費用證明自費藥費欄位名稱",
            self.ui.lineEdit_medicine_fee_field_name.text(),
        )
        self.system_settings.post(
            "醫療費用證明自費處置欄位名稱", self.ui.lineEdit_treat_fee_field_name.text()
        )
        self.system_settings.post(
            "醫療費用證明其他費用欄位名稱", self.ui.lineEdit_misc_fee_field_name.text()
        )
        self.system_settings.post(
            "醫療費用證明自費金額欄位名稱", self.ui.lineEdit_total_fee_field_name.text()
        )
        self.system_settings.post(
            "醫療費用自付明細自費金額欄位名稱",
            self.ui.lineEdit_total_fee_field_name2.text(),
        )
        self.system_settings.post(
            "醫療費用收據自訂報稅備註", self.ui.plainTextEdit_tax_remark.toPlainText()
        )
        ...
        self.system_settings.post(
            "自訂院所名稱", self.ui.lineEdit_custom_clinic_name.text()
        )
        ...
        self.system_settings.post(
            "健保醫療收據寬度", self.ui.doubleSpinBox_ins_receipt_width.value()
        )
        self.system_settings.post(
            "健保醫療收據長度", self.ui.doubleSpinBox_ins_receipt_length.value()
        )
        self.system_settings.post(
            "健保醫療收據尺寸單位", self.ui.comboBox_ins_receipt_size_unit.currentText()
        )

        self.system_settings.post(
            "健保醫療收據左邊界", self.ui.doubleSpinBox_ins_receipt_left_margin.value()
        )
        self.system_settings.post(
            "健保醫療收據上邊界", self.ui.doubleSpinBox_ins_receipt_top_margin.value()
        )
        self.system_settings.post(
            "健保醫療收據邊界單位",
            self.ui.comboBox_ins_receipt_margin_unit.currentText(),
        )
        ...
        self.system_settings.post(
            "自費醫療收據寬度", self.ui.doubleSpinBox_self_receipt_width.value()
        )
        self.system_settings.post(
            "自費醫療收據長度", self.ui.doubleSpinBox_self_receipt_length.value()
        )
        self.system_settings.post(
            "自費醫療收據尺寸單位",
            self.ui.comboBox_self_receipt_size_unit.currentText(),
        )

        self.system_settings.post(
            "自費醫療收據左邊界", self.ui.doubleSpinBox_self_receipt_left_margin.value()
        )
        self.system_settings.post(
            "自費醫療收據上邊界", self.ui.doubleSpinBox_self_receipt_top_margin.value()
        )
        self.system_settings.post(
            "自費醫療收據邊界單位",
            self.ui.comboBox_self_receipt_margin_unit.currentText(),
        )
        ...
        self._save_check_box(
            self.ui.checkBox_print_self_fee, "列印所有收費收據費用明細"
        )
        self._save_check_box(
            self.ui.checkBox_print_each_self_fee, "列印所有收費收據各自金額"
        )
        ...
        self.system_settings.post(
            "費用收據處方欄字體大小", self.ui.spinBox_prescript_font_size.value()
        )
        self.system_settings.post(
            "醫療費用證明預設金額", self.ui.spinBox_certificate_diag_default_fee.value()
        )
    ...
    def _save_reader_settings(self):
        ...
        self.system_settings.post(
            "健保卡讀卡機連接埠", self.ui.spinBox_ic_reader_port.value()
        )
        self._save_radio_button(
            [
                self.ui.radioButton_smart_card_reader,
    ...
    def _save_misc(self):
        ...
        self.system_settings.post(
            "電子病歷交換檔輸出路徑", self.ui.lineEdit_emr_path.text()
        )
        self.system_settings.post("資料路徑", self.ui.lineEdit_clinic_dir.text())
        self.system_settings.post(
            "異地備份路徑", self.ui.lineEdit_external_backup_dir.text()
        )
        self.system_settings.post(
            "伺服器物理備份路徑", self.ui.lineEdit_database_physical_dir.text()
        )
        self.system_settings.post(
            "伺服器資料來源", self.ui.lineEdit_database_dir.text()
        )
        self.system_settings.post("影像檔路徑", self.ui.lineEdit_image_path.text())
        self.system_settings.post(
            "電子處方箋路徑", self.ui.lineEdit_electronic_prescript_path.text()
        )
        self.system_settings.post(
            "掛號機錢箱路徑", self.ui.lineEdit_cashier_machine_path.text()
        )
        self.system_settings.post(
            "血壓計路徑", self.ui.lineEdit_blood_measure_path.text()
        )
        self.system_settings.post(
            "叫號燈連接埠", self.ui.comboBox_led_port.currentText()
        )
        ...
        self.system_settings.post(
            "封存資料庫名稱", self.ui.lineEdit_archive_database_name.text()
        )
        self.system_settings.post(
            "自訂叫號格式", self.ui.lineEdit_voice_call_format.text()
        )
    ...
    def _get_emr_path(self):
        ...
        directory = QFileDialog.getExistingDirectory(
            self,
            "選擇電子病歷交換檔路徑",
            self.ui.lineEdit_emr_path.text(),
            options=options,
        )
        if directory:
    ...
    def _get_image_path(self):
        options = QFileDialog.DontResolveSymlinks | QFileDialog.ShowDirsOnly
        directory = QFileDialog.getExistingDirectory(
            self, "選擇影像檔路徑", self.ui.lineEdit_image_path.text(), options=options
        )
        if directory:
    ...
    def _get_electronic_prescript_path(self):
        ...
        directory = QFileDialog.getExistingDirectory(
            self,
            "選擇電子處方箋路徑",
            self.ui.lineEdit_electronic_prescript_path.text(),
            options=options,
        )
        if directory:
    ...
    def _get_cashier_machine_path(self):
        ...
        directory = QFileDialog.getExistingDirectory(
            self,
            "選擇掛號機錢箱路徑",
            self.ui.lineEdit_cashier_machine_path.text(),
            options=options,
        )
        if directory:
    ...
    def _get_blood_measure_path(self):
        ...
        directory = QFileDialog.getExistingDirectory(
            self,
            "選擇血壓計路徑",
            self.ui.lineEdit_blood_measure_path.text(),
            options=options,
        )
        if directory:
    ...
    def _read_station_list(self):
        sql = """
            ...
            GROUP BY StationNo
        """
        self.table_widget_station_list.set_db_data(
            sql, self._set_table_widget_station_list
        )
    ...
    def _set_table_widget_station_list(self, row_no, row):
        ...
        for col_no in range(len(station_list_row)):
            ...
            if col_no in [0]:
                self.ui.tableWidget_station_list.item(row_no, col_no).setTextAlignment(
                    QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter
                )
            elif col_no in [3, 4]:
                self.ui.tableWidget_station_list.item(row_no, col_no).setTextAlignment(
    ...
    def _remove_station_row(self, station_no):
        ...
        self.ui.tableWidget_station_list.removeRow(
            self.ui.tableWidget_station_list.currentRow()
        )
    ...
    def _insert_start_no(self, room, start_no_1, start_no_2, start_no_3):
        ...
        for col_no in range(len(start_no_row)):
            self.ui.tableWidget_start_no.setItem(
                row_no,
                col_no,
                QtWidgets.QTableWidgetItem(string_utils.xstr(start_no_row[col_no])),
            )
            if col_no in [1, 2, 3]:
                self.ui.tableWidget_start_no.item(row_no, col_no).setTextAlignment(
                    QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter
    ...
    def _modify_start_no(self, row_no, room, start_no_1, start_no_2, start_no_3):
        ...
        for col_no in range(len(start_no_record)):
            self.ui.tableWidget_start_no.setItem(
                row_no,
                col_no,
                QtWidgets.QTableWidgetItem(string_utils.xstr(start_no_record[col_no])),
            )
            if col_no in [1, 2, 3]:
                self.ui.tableWidget_start_no.item(row_no, col_no).setTextAlignment(
                    QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter
    ...
    def _edit_web_bulletin(self):
        ...
        title = self.ui.tableWidget_bulletin.item(
            self.ui.tableWidget_bulletin.currentRow(), 0
        ).text()
        content = self.ui.tableWidget_bulletin.item(
            self.ui.tableWidget_bulletin.currentRow(), 1
        ).text()
        ...
        if dialog.exec_():
            title = dialog.ui.lineEdit_title.text()
            content = dialog.ui.plainTextEdit_content.toPlainText()
            self._modify_web_bulletin(
                self.ui.tableWidget_bulletin.currentRow(), title, content
            )
    ...
    def _remove_web_bulletin(self):
        msg_box = dialog_utils.get_message_box(
            "刪除公告",
            QtWidgets.QMessageBox.Warning,
            '<font size="5" color="red"><b>確定刪除此筆公告內容?</b></font>',
            "注意！資料刪除後, 將無法回復!",
        )
        remove_record = msg_box.exec_()
        if not remove_record:
    ...
    def _insert_web_bulletin(self, title, content):
        ...
        for col_no in range(len(bulletin_row)):
            self.ui.tableWidget_bulletin.setItem(
                row_no,
                col_no,
                QtWidgets.QTableWidgetItem(string_utils.xstr(bulletin_row[col_no])),
            )
    ...
    def _remove_notice(self):
        ...
        msg_box = dialog_utils.get_message_box(
            "刪除注意事項",
            QtWidgets.QMessageBox.Warning,
            '<font size="5" color="red"><b>確定刪除此筆注意事項?</b></font>',
            "注意！資料刪除後, 將無法回復!",
        )
        remove_record = msg_box.exec_()
        if not remove_record:
