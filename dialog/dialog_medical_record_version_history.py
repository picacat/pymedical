...
from libs import case_utils, class_utils, string_utils, system_utils, ui_utils
...
class DialogMedicalRecordVersionHistory(QtWidgets.QDialog):
    ...
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(
            ui_utils.UI_DIALOG_MEDICAL_RECORD_VERSION_HISTORY, self
        )
        ...
        self.ui.tableWidget_medical_record.setVerticalScrollMode(
    ...
    def _set_table_data(self, row_no, row):
        ...
        self.ui.tableWidget_medical_record.setItem(
            row_no,
            0,
            QtWidgets.QTableWidgetItem(string_utils.xstr(row["BackupRecordsKey"])),
        )
