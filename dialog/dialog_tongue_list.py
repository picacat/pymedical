...
# 病歷點選舌診辭庫列表
class DialogTongueList(QtWidgets.QDialog):
    # 初始化
    def __init__(self, parent=None, *args):
        super(DialogTongueList, self).__init__(parent)
        self.parent = parent
    ...
    def add_pulse(self):
        clinic_key = self.table_widget_pulse.field_value(0)
        selected_pulse = self.table_widget_pulse.field_value(1)
        self.parent.parent.insert_text(self.text_edit, selected_pulse, '')
