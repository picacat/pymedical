...
class DialogDisease(QtWidgets.QDialog):
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(ui_utils.UI_DIALOG_DISEASE2, self)
    ...
    def _set_table_width(self):
        ...
        disease_width = [100, 100, 70, 100, 520]
    ...
    def _set_groups(self):
        self._enable_table_widget_groups(True)
        ...
        if self.ui.radioButton_chronic.isChecked():
            ...
            self._enable_table_widget_groups(False)
    ...
    def _enable_table_widget_groups(self, enabled):
        if not enabled:
            self.ui.tableWidget_groups.clear()

        self.ui.tableWidget_groups.setEnabled(enabled)
