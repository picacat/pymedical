...
class DialogMedicine(QtWidgets.QDialog):
    ...
    def _add_medicine(self):
        ...
        try:
            tab_prescript = self.parent.tab_list[self.medicine_set-1]   # call by ins_prescript/self_prescript
        ...
        if self.dict_type == '養生館':
            ...
            prescript_utils.extract_compound(tab_prescript, self.database, self.system_settings,
                                             medicine_key, self.table_widget_medicine)
