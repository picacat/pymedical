...
class InsCareRecord(QtWidgets.QMainWindow):
    ...
    def open_medicine_dialog(self):
        ...
        if len(rows) <= 0:
            ...
            dialog = dialog_utils.get_dialog_input_medicine(
                self, self.database, self.system_settings, None, self.medicine_set, self.ui.tableWidget_prescript,
            )
            dialog.exec_()
            dialog.deleteLater()
    ...
    def set_cancer_prescript(self, pres_days):
        ...
        self._remove_specific_treat_code(['P56001', 'P56002', 'P56003', 'P56004', 'P56008'])  # 歸零
        self._remove_specific_treat_code(['P56001', 'P56002', 'P56003', 'P56004', 'P56008'])  # 歸零
        self._add_care_row(treat_code, self.ui.tableWidget_prescript.rowCount())
    ...
    def set_kidney_prescript(self, pres_days, treatment, course):
        ...
        clear_ins_code = [
            'P64001', 'P64002', 'P64003', 'P64004', 'P64005',
            'P64006', 'P64007', 'P64008', 'P64009', 'P64010',
        ]
