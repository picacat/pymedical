...
class ChargeSettingsRegist(QtWidgets.QMainWindow):
    ...
    def _set_ui(self):
        ...
        self.table_widget_regist_fee = class_utils.get_table_widget(self.ui.tableWidget_regist_fee, self.database)
        self.table_widget_regist_fee.set_column_hidden([0, 1])
        self.table_widget_discount = class_utils.get_table_widget(self.ui.tableWidget_discount, self.database)
    ...
    def _set_signal(self):
        ...
        self.ui.spinBox_old_man_age.valueChanged.connect(self._spin_box_old_man_value_changed)
        self.ui.spinBox_child_age.valueChanged.connect(self._spin_box_child_value_changed)
    ...
    def _discount_add(self):
        dialog = dialog_utils.get_dialog_input_discount(self, self.database, self.system_settings, None)
        result = dialog.exec_()
        if result != 0:
