...
def adjust_self_prescript(database, case_key, medicine_set, check_adjust_stock=True):
    if check_adjust_stock and case_utils.get_doctor_done(database, case_key):  # 完診就不再調整庫存
        return
