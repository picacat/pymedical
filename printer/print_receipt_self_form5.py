...
class PrintReceiptSelfForm5:
    ...
    def print_html(self, printing=None):
        ...
        printer_utils.set_paper_size(self.printer, self.system_settings, 7.2, 2.5, QPrinter.Inch, '自費醫療收據')
    ...
    def _html(self):
        ...
        case_record = printer_utils.get_case_html_1(self.database, self.case_key, '自費', print_time_label=True)
        disease_record = printer_utils.get_disease2(self.database, self.system_settings, self.case_key)
        if disease_record != '':
            disease_record = f'適應症: {disease_record}<br>'
                  ...
                  <thead>
                    <tr>
                      ...
                      <th style="font-weight: 300">
                        <font style="font-family:Code 128">
                            {case_key_barcode}
                        </font>
                      </th>
                    </tr>
