...
class PrintDiagnosisProof:
    ...
    def _get_html_title(self, row):
        ...
        if self.title == '診斷證明書':
            ...
            english_title = 'CERTIFICATE OF MEDICAL'

        html = f'''
            <h1 style="text-align: center">{clinic_name} {self.title}<br>{english_title}</h1>
            <table align=center width="98%" cellspacing="0">
                <tbody>
                    <tr>
                        <td><h3>編號 <font size="5">Certificate No.</font> {certificate_key}</h3></td>
                    </tr>
                </tbody>
            </table>
        '''
    ...
    def _get_html_patient(self, row):
        ...
        html = f'''
            <table align=center cellpadding="2" cellspacing="0" width="98%"
                ...
                <tbody>
                    <tr>
                        <th{self.html_bg_color} width="12%">姓名<br><font size="5">Name</font></th>
                        <td style="text-align: center; vertical-align: middle" width="18%">{name}</td>
                        <th{self.html_bg_color} width="12%">性別<br><font size="5">Gender</font></th>
                        <td style="text-align: center; vertical-align: middle" width="20%">{gender}</td>
    ...
    def _get_html_detail(self, row):
        ...
        html = f'''
            <table align=center cellpadding="10" cellspacing="0" width="98%"
                ...
                <tbody>
                    <tr>
                        <th{self.html_bg_color} style="text-align: left; vertical-align: middle">
                            病名 <font size="5">Diagnosis</font>
                        </th>
                    </tr>
                    <tr>
                        <td style="white-space:pre-line">{diagnosis}<br><br><br><br><br><br></td>
                    </tr>
                    <tr>
                        <td>
                            <h2>
                                以上病人在本院(所)就醫屬實特予證明<br>
                                <font size="5">
                                    This certificate is invalid without the seal of the Hospital Director.
                                </font>
                            </h2>
                            <h2>
                                診治醫師 <font size="5">Physician</font>: {physician}<br><br>
                                簽章<br><br><br>
                            </h2>
                            <h2>
                            ...
                            <h2>
                                開立就醫證明書日期 <font size="5">Certificate Date</font>: {certificate_date}
                            </h2>
                        </td>
                    </tr>
                </tbody>
