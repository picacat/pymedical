...
# 其他收據格式6 6.5 x 2.5 inches
# 2020.08.24 明醫
class PrintMiscForm6:
    # 初始化
    ...
    def _html(self):
        case_record = printer_utils.get_case_html_4(self.database, self.case_key, '全部')
        fees_record = printer_utils.get_fees_html2(self.database, self.case_key)
