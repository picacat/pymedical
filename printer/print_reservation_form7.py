              ...
              <body>
                <table width="95%" cellspacing="0">
                  <thead>
                    ...
                    <tr>
                      <th align="left" colspan="5">院址: {clinic_address}<br>電話: {clinic_telephone}</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
                ...
                <table width="95%" cellspacing="0" style="font-size: 18px">
                  <tbody>
                    ...
                    <tr>
                      <td>醫師: {doctor}</td>
                      <td>日期: <b>{reservation_date}</b></td>
                    </tr>
                    <tr>
                      <td>時間: <b>{weekday_name}</b></td>
                      <td>{period} {reservation_time}</td>
                    </tr>
                    {label_reservation_no}
                  </tbody>
                </table>
