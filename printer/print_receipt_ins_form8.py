...
class PrintReceiptInsForm8:
    ...
    def print_html(self, printing=None):
        ...
        printer_utils.set_paper_size(self.printer, self.system_settings, 4.0, 3, QPrinter.Inch, '健保醫療收據')

        document = printer_utils.get_document(self.printer, self.font)
        document.setDocumentMargin(printer_utils.get_document_margin())
        document.setHtml(self._html())
        printer_utils.set_document_line_height(document, 11)
        if printing:
    ...
    def _get_prescript_html(self, row):
        ...
        prescript_record = printer_utils.get_prescript_html2(
            ...
            '費用收據', blocks=2, instruction=self.additional, max_line=8)
