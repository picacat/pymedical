...
class PrintRegistrationForm7:
    ...
    def print_painter(self):
        ...
        painter.drawText(
            20,
            66,
            medical_record["clinic_telephone"] + " " + medical_record["clinic_address"],
        )
        ...
        painter.drawText(
            320, lines[2], string_utils.xstr(medical_record["diag_share_fee"])
        )
        painter.drawText(
            450, lines[2], string_utils.xstr(medical_record["deposit_fee"])
        )
