            ...
            <html>
                <body>
                    ...
                    <table cellspacing=0 cellpadding=0>
                        <tr>
                            <td width="20%" style="font-size: 16px; text-align: center">{room}</td>
                            <td width="15%" style="font-size: 16px">{ins_type}</td>
                            <td width="20%" style="font-size: 16px; text-align:center">{regist_fee}</td>
                            <td width="15%" style="font-size: 16px; text-align:left">{deposit_fee}</td>
                            <td width="25%" style="font-size: 16px; text-align:center">{case_date}</td>
                        </tr>
                    </table>
                    <br>
                    <table cellspacing=0 cellpadding=0>
                        <tr>
                            <td width="20%"></td>
                            <td width="30%" style="font-size: 16px">卡序:{card}</td>
                            <td width="30%" style="font-size: 16px">部份負擔:{diag_share_fee}元</td>
                            <td width="20%" style="font-size: 16px">班別:{period} {deposit_hint}</td>
                        </tr>
                    </table>
                </body>
            </html>
