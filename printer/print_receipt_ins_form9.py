...
# 健保收據格式9 友杏格式 4.5 x 3 inches 8號字
# 2018.10.09
class PrintReceiptInsForm9:
    # 初始化
    ...
    def print_html(self, printing=None):
        ...
        # self.printer.setPaperSize(QtCore.QSizeF(4.4, 3), QPrinter.Inch)
        printer_utils.set_paper_size(self.printer, self.system_settings, 4.4, 3, QPrinter.Inch, '健保醫療收據')
    ...
    def _get_prescript_html(self, row):
        ...
        prescript_record = printer_utils.get_prescript_html2(
            ...
            '費用收據', blocks=2, instruction=self.additional, max_line=7)
