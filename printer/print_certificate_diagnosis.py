...
class PrintCertificateDiagnosis:
    ...
    def _get_html_patient(self, row):
        ...
        if self.system_settings.field("列印診斷證明日期明細") == "Y":
            ...
            case_list_row = f"""
                <tr>
                    <th{self.html_bg_color}>診療明細<br><font size="5">Date List</font></th>
        ...
        chinese_birthday = date_utils.west_date_to_nhi_date(
            patient_row["Birthday"], "-"
        )
            ...
            <table align=center cellpadding="2" cellspacing="0" width="98%"
                ...
                <tbody>
                    <tr>
                        ...
                        <th{self.html_bg_color} width="12%">出生日期<br><font size="5">DOB</font></th>
                    ...
                    <tr>
                        ...
                        <th{self.html_bg_color}>診療日期<br><font size="5">Exam Date</font></th>
        ...
        html = f'''
            <table align=center cellpadding="10" cellspacing="0" width="98%"
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="{self.font_size}; white-space:pre-line">{diagnosis}</td>
                    </tr>
                    <tr>
                        <th{self.html_bg_color} style="{self.font_size}; text-align: left; vertical-align: middle">
                    ...
                    <tr>
                        <td style="{self.font_size}; white-space:pre-line">{doctor_comment}</td>
                    </tr>
                    <tr>
                        <td>
                            <h2>
