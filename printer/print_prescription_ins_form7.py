...
# 健保處方箋格式3 4 x 3 inches
# 2019.02.13
class PrintPrescriptionInsForm7:
    # 初始化
    ...
    def print_html(self, printing=None):
        ...
        self.printer.setPaperSize(QtCore.QSizeF(4, 3), QPrinter.Inch)
    ...
    def _html(self):
        case_record = printer_utils.get_case_html_9(
