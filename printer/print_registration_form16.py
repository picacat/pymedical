...
class PrintRegistrationForm16:
    ...
    def print_painter(self):
        ...
        painter.drawText(120, lines[1]+20, date_utils.date_to_zh_tw_date(medical_record['birthday']))
        ...
        painter.drawText(120, lines[3], medical_record['case_date'])
        painter.setFont(font)
        painter.drawText(210, lines[3], medical_record['case_time'])
