...
class PrintMassageForm14:
    ...
    def print_painter(self):
        ...
        painter.drawText(105, lines[2], '自費')
        # painter.drawText(180, lines[2], string_utils.xstr(medical_record['regist_fee']))
        # painter.drawText(270, lines[2], string_utils.xstr(medical_record['deposit_fee']))
        ...
        painter.drawText(300, lines[3], f"民俗調理:{medical_record['massage_fee']}")
