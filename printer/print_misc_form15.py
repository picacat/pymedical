...
class PrintMiscForm15:
    ...
    def print_html(self, printing=None):
        ...
        printer_utils.set_paper_size(self.printer, self.system_settings, 54, 110, QPrinter.Millimeter, '健保醫療收據')
        ...
        html = f'''
            <html>
              <body>
                ...
                <br>
                此致
                <p style="margin-left: 10px">{clinic_name}</p>
                <p style="margin-left: 10px">立同意書人:<br><br>
                  _______________ (簽章)</p>
