...
# 熱感印花稅總繳收據 2026-07-03 沐禾
# 2026.07.03
class PrintMiscForm18:
    # 初始化
                  ...
                  <td width="45%">
                    <table cellpadding="3" cellspacing="0" style="font-size:11px;
                     border-width:1px; border-style: solid; border-color: black;">
                      ...
                      <tr>
                        <td style="vertical-align: middle; padding: 15px 0;">{clinic_address[:3]}</td>
                        <td align="center">負責總繳人:<br>{owner}</td>
                      </tr=>
                    </table>
                  </td>
                </tr>
    ...
    def _get_self_prescript_html(self, row):
        case_record = printer_utils.get_case_html_0(
            self.database,
            self.case_key,
            "自費",
            self.medicine_set,
                  ...
                  <td width="45%">
                    <table cellpadding="3" cellspacing="0" style="font-size:11px;
                     border-width:1px; border-style: solid; border-color: black;">
                      ...
                      <tr>
                        <td colspan="2" style="vertical-align: middle; padding: 12px 0;">
                            <center>本醫療收據</center>
                            <center>印花稅總繳</center>
                        </td>
                      </tr>
                      <tr>
                        <td style="vertical-align: middle">{clinic_address[:3]}</td>
                        <td>負責總繳人:{owner}</td>
                      </tr=>
                    </table>
                  </td>
