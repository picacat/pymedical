...
class PrintMiscForm16:
    ...
    def print_html(self, printing=None):
        ...
        printer_utils.set_paper_size(self.printer, self.system_settings, 74, 200, QPrinter.Millimeter, '健保醫療收據')
    ...
    def _html(self):
        ...
        prescript_record = printer_utils.get_self_prescript_receipt_html(
            ...
            <html>
              <body>
                ...
                <p style="margin-left: 10px; margin-right: 10px">
                    ...
                    自願自費使用之自費項目共計<u>新台幣{total_fee}元整</u>,
                    並同意繳費無異議.<br><br>
                    以下為購買明細:
                </p>
                <table style="margin-left:10px; margin-right: 10px;
                    border-collapse: collapse; border:1px #cccccc solid;" cellpadding="2" border="1">
                    {prescript_record}
                </table>
                <p style="margin-left: 10px">此致</p>
                <p style="margin-left: 50px">{clinic_name}</p>
                <p style="margin-left: 10px">立同意書人:<br><br><br>
                  _________________________ (簽章)</p>
                <p style="margin-left: 10px">中華民國 {current_year} 年 {current_month} 月 {current_day} 日</p>
              </body>
            </html>
        '''
