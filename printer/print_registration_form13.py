...
class PrintRegistrationForm13:
    ...
    def print_painter(self):
        ...
        painter.drawText(20, 20, medical_record['clinic_id'])
        painter.drawText(140, 20, medical_record['clinic_name'])
        ...
        painter.drawText(340, lines[3], string_utils.xstr(medical_record['registrar']))
