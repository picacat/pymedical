...
class PrintReceiptSelfForm2:
    ...
    def print_html(self, printing=None):
        ...
        printer_utils.set_paper_size(self.printer, self.system_settings, 7.8, 2, QPrinter.Inch, '自費醫療收據')
        ...
        html = f'''
            <html>
              <body>
                ...
                <font style="font-size: {self.font_size}px">
                    院址: {clinic_address} 電話: {clinic_telephone} * 本收據可為報稅之憑證, 遺失恕不補發<br>
                </font>
              </body>
            </html>
        '''
