...
# 收據總表格式9 4.4 x 3 inches
# 2020.08.28
class PrintReceiptSelfForm9:
    # 初始化
    ...
    def print_html(self, printing=None):
        ...
        printer_utils.set_paper_size(self.printer, self.system_settings, 4.3, 3, QPrinter.Inch, '自費醫療收據')
    ...
    def _html(self):
        case_record = printer_utils.get_case_html_7(self.database, self.case_key, '自費')
        fees_record = printer_utils.get_fees_html3(self.database, self.case_key)
            ...
            <html>
              <body>
                <table width="95%" cellspacing="0">
                  <thead>
                    <tr>
                      <th style="text-align: left; font-size: 14px" colspan="3">
