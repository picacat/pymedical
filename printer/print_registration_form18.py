...
# 掛號收據格式18 2.5"套表掛號單 (佳禾)
# 2023.10.01
class PrintRegistrationForm18:
    # 初始化
    ...
    def _get_medical_record(self):
        ...
        return_card_note = ''
        total_fee = string_utils.xstr(regist_fee + diag_share_fee + deposit_fee - return_fee)
    ...
    def print_painter(self):
        ...
        painter.drawText(358, lines[4], medical_record['card'])

        font = QtGui.QFont(self.font_name, 13, QtGui.QFont.PreferQuality)
        painter.setFont(font)
        painter.drawText(68, lines[5], medical_record['ins_type'])
