...
class PyCashier(QtWidgets.QMainWindow):
    ...
    def _set_pycashier_home(self):
        self.widget_home = module_utils.get_pycashier_home(self, self.database, self.system_settings, self.ic_card)
        self.ui.stackedWidget.addWidget(self.widget_home)

    def _set_pycashier_registration(self):
        self.widget_registration = module_utils.get_pycashier_registration(
    ...
    def _set_pycashier_payment(self):
        self.widget_payment = module_utils.get_pycashier_payment(
    ...
    def _set_pycashier_completed(self):
        self.widget_completed = module_utils.get_pycashier_completed(
            self, self.database, self.system_settings, self.ic_card,
        )
