...
class StatisticsDoctor(QtWidgets.QMainWindow):
    ...
    def _set_tab_widget(self, start_date, end_date, period, ins_type, doctor, option, weekday_list):
        ...
        self._add_statistic_doctor_count(start_date, end_date, period, ins_type, doctor, option, weekday_list)
        self._add_statistic_doctor_income(start_date, end_date, period, ins_type, doctor, option, weekday_list)
        self._add_statistic_doctor_sale(start_date, end_date, period, doctor, option, weekday_list)
        self._add_statistic_doctor_visit_count(start_date, end_date, period, doctor, option, weekday_list)
        self._add_statistic_designated_doctor_visit_count(start_date, end_date, period, doctor, option, weekday_list)
        self._add_statistic_doctor_summary(start_date, end_date, period, doctor, option, weekday_list)
        self._add_statistic_doctor_achievement(start_date, end_date, period, doctor, option, weekday_list)

    # 醫師門診人數統計
    def _add_statistic_doctor_count(self, start_date, end_date, period, ins_type, doctor, option, weekday_list):
        self.tab_statistics_doctor_count = module_utils.get_statistics_doctor_count(
    ...
    # 醫師門診收入統計
    def _add_statistic_doctor_income(self, start_date, end_date, period, ins_type, doctor, option, weekday_list):
        self.tab_statistics_doctor_income = module_utils.get_statistics_doctor_income(
            self, self.database, self.system_settings, start_date, end_date, period, ins_type,
            doctor, option, weekday_list
        )
    ...
    # 醫師自費銷售統計
    def _add_statistic_doctor_sale(self, start_date, end_date, period, doctor, option, weekday_list):
        self.tab_statistics_doctor_sale = module_utils.get_statistics_doctor_sale(
            self, self.database, self.system_settings, start_date, end_date, period, doctor, option, weekday_list,
        )
    ...
    # 門診初複診統計
    def _add_statistic_doctor_visit_count(self, start_date, end_date, period, doctor, option, weekday_list):
        self.tab_statistics_doctor_visit_count = module_utils.get_statistics_doctor_visit_count(
            self, self.database, self.system_settings,
            start_date, end_date, period, doctor, option, weekday_list
        )
        self.tab_statistics_doctor_visit_count.start_calculate()
        self.ui.tabWidget_statistics_doctor.addTab(self.tab_statistics_doctor_visit_count, '初複診統計')

    # 門診指定醫師初複診統計
    def _add_statistic_designated_doctor_visit_count(self, start_date, end_date, period, doctor, option, weekday_list):
        self.tab_statistics_designated_doctor_visit_count = module_utils.get_statistics_designated_doctor_visit_count(
                self, self.database, self.system_settings, start_date, end_date, period, doctor, option, weekday_list
            )
        self.tab_statistics_designated_doctor_visit_count.start_calculate()
        self.ui.tabWidget_statistics_doctor.addTab(
            self.tab_statistics_designated_doctor_visit_count, '指定醫師初複診統計')

    # 門診收入總覽
    def _add_statistic_doctor_summary(self, start_date, end_date, period, doctor, option, weekday_list):
        self.tab_statistics_doctor_achievement = module_utils.get_statistics_doctor_summary(
            self, self.database, self.system_settings, start_date, end_date, period,
            doctor, option, weekday_list
        )
        self.tab_statistics_doctor_achievement.start_calculate()
        self.ui.tabWidget_statistics_doctor.addTab(self.tab_statistics_doctor_achievement, '門診收入總覽')

    # 醫師業績
    def _add_statistic_doctor_achievement(self, start_date, end_date, period, doctor, option, weekday_list):
        self.tab_statistics_doctor_achievement = module_utils.get_statistics_doctor_achievement(
            self, self.database, self.system_settings, start_date, end_date, period,
            doctor, option, weekday_list
        )
        self.tab_statistics_doctor_achievement.start_calculate()
        self.ui.tabWidget_statistics_doctor.addTab(self.tab_statistics_doctor_achievement, '醫師業績')
