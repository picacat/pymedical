...
--
-- Table structure for table `case_extension`
--

DROP TABLE IF EXISTS `case_extension`;
...
--
-- Dumping data for table `case_extension`
--

LOCK TABLES `case_extension` WRITE;
/*!40000 ALTER TABLE `case_extension` DISABLE KEYS */;
/*!40000 ALTER TABLE `case_extension` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-13 12:59:53
