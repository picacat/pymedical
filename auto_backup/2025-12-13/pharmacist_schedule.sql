...
--
-- Table structure for table `pharmacist_schedule`
--

DROP TABLE IF EXISTS `pharmacist_schedule`;
...
--
-- Dumping data for table `pharmacist_schedule`
--

LOCK TABLES `pharmacist_schedule` WRITE;
/*!40000 ALTER TABLE `pharmacist_schedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `pharmacist_schedule` ENABLE KEYS */;
UNLOCK TABLES;
