...
DROP TABLE IF EXISTS `stockoutitems`;
...
LOCK TABLES `stockoutitems` WRITE;
/*!40000 ALTER TABLE `stockoutitems` DISABLE KEYS */;
/*!40000 ALTER TABLE `stockoutitems` ENABLE KEYS */;
UNLOCK TABLES;
