...
DROP TABLE IF EXISTS `insappeal_items`;
...
--
-- Dumping data for table `insappeal_items`
--

LOCK TABLES `insappeal_items` WRITE;
/*!40000 ALTER TABLE `insappeal_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `insappeal_items` ENABLE KEYS */;
UNLOCK TABLES;
