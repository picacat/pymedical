...
--
-- Table structure for table `presextend`
--

DROP TABLE IF EXISTS `presextend`;
...
--
-- Dumping data for table `presextend`
--

LOCK TABLES `presextend` WRITE;
/*!40000 ALTER TABLE `presextend` DISABLE KEYS */;
/*!40000 ALTER TABLE `presextend` ENABLE KEYS */;
UNLOCK TABLES;
