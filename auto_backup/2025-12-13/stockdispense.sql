...
--
-- Table structure for table `stockdispense`
--

DROP TABLE IF EXISTS `stockdispense`;
...
--
-- Dumping data for table `stockdispense`
--

LOCK TABLES `stockdispense` WRITE;
/*!40000 ALTER TABLE `stockdispense` DISABLE KEYS */;
/*!40000 ALTER TABLE `stockdispense` ENABLE KEYS */;
UNLOCK TABLES;
