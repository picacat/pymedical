...
--
-- Table structure for table `insappeal`
--

DROP TABLE IF EXISTS `insappeal`;
...
--
-- Dumping data for table `insappeal`
--

LOCK TABLES `insappeal` WRITE;
/*!40000 ALTER TABLE `insappeal` DISABLE KEYS */;
/*!40000 ALTER TABLE `insappeal` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-13 12:59:57
