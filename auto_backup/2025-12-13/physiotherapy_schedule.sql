...
--
-- Table structure for table `physiotherapy_schedule`
--

DROP TABLE IF EXISTS `physiotherapy_schedule`;
...
--
-- Dumping data for table `physiotherapy_schedule`
--

LOCK TABLES `physiotherapy_schedule` WRITE;
/*!40000 ALTER TABLE `physiotherapy_schedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `physiotherapy_schedule` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-13 13:00:00
