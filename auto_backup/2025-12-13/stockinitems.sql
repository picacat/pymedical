...
DROP TABLE IF EXISTS `stockinitems`;
...
--
-- Dumping data for table `stockinitems`
--

LOCK TABLES `stockinitems` WRITE;
/*!40000 ALTER TABLE `stockinitems` DISABLE KEYS */;
/*!40000 ALTER TABLE `stockinitems` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-13 13:00:02
