...
--
-- Table structure for table `doctor_extra_duty`
--

DROP TABLE IF EXISTS `doctor_extra_duty`;
...
--
-- Dumping data for table `doctor_extra_duty`
--

LOCK TABLES `doctor_extra_duty` WRITE;
/*!40000 ALTER TABLE `doctor_extra_duty` DISABLE KEYS */;
/*!40000 ALTER TABLE `doctor_extra_duty` ENABLE KEYS */;
UNLOCK TABLES;
