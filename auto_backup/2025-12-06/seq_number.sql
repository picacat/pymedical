...
--
-- Table structure for table `seq_number`
--

DROP TABLE IF EXISTS `seq_number`;
...
--
-- Dumping data for table `seq_number`
--

LOCK TABLES `seq_number` WRITE;
/*!40000 ALTER TABLE `seq_number` DISABLE KEYS */;
/*!40000 ALTER TABLE `seq_number` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-06  7:00:33
