...
CREATE TABLE `examination_item` (
  `ExaminationItemKey` int(11) NOT NULL AUTO_INCREMENT,
  `ExaminationKey` int(11) NOT NULL,
  `PatientKey` int(11) NOT NULL,
  `Name` varchar(20) DEFAULT NULL,
  `ExaminationDate` date NOT NULL,
  `ExaminationItem` varchar(50) DEFAULT NULL,
  `TestResult` varchar(40) DEFAULT NULL,
  `TimeStamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`ExaminationItemKey`),
  KEY `ExaminationKey` (`ExaminationKey`,`PatientKey`,`ExaminationDate`)
...
-- Dump completed on 2025-12-05 23:02:03
