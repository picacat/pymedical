...
--
-- Table structure for table `custom_disease`
--

DROP TABLE IF EXISTS `custom_disease`;
...
--
-- Dumping data for table `custom_disease`
--

LOCK TABLES `custom_disease` WRITE;
/*!40000 ALTER TABLE `custom_disease` DISABLE KEYS */;
/*!40000 ALTER TABLE `custom_disease` ENABLE KEYS */;
UNLOCK TABLES;
