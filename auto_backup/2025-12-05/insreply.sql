...
--
-- Dumping data for table `insreply`
--

LOCK TABLES `insreply` WRITE;
/*!40000 ALTER TABLE `insreply` DISABLE KEYS */;
/*!40000 ALTER TABLE `insreply` ENABLE KEYS */;
UNLOCK TABLES;
