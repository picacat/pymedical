...
--
-- Dumping data for table `hospid`
--

LOCK TABLES `hospid` WRITE;
/*!40000 ALTER TABLE `hospid` DISABLE KEYS */;
/*!40000 ALTER TABLE `hospid` ENABLE KEYS */;
UNLOCK TABLES;
