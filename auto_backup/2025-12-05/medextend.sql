...
--
-- Table structure for table `medextend`
--

DROP TABLE IF EXISTS `medextend`;
...
--
-- Dumping data for table `medextend`
--

LOCK TABLES `medextend` WRITE;
/*!40000 ALTER TABLE `medextend` DISABLE KEYS */;
/*!40000 ALTER TABLE `medextend` ENABLE KEYS */;
UNLOCK TABLES;
