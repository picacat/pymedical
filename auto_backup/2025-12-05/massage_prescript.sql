...
--
-- Table structure for table `massage_prescript`
--

DROP TABLE IF EXISTS `massage_prescript`;
...
--
-- Dumping data for table `massage_prescript`
--

LOCK TABLES `massage_prescript` WRITE;
/*!40000 ALTER TABLE `massage_prescript` DISABLE KEYS */;
/*!40000 ALTER TABLE `massage_prescript` ENABLE KEYS */;
UNLOCK TABLES;
