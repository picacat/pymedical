...
class StatisticsBusinessIncome(QtWidgets.QMainWindow):
    ...
    def _set_tab_widget(
        ...
        self._add_statistic_business_income_list(
            start_date, end_date, period, ins_type, doctor, option, weekday_list
        )

    # 醫師門診人數統計
    def _add_statistic_business_income_list(
        self, start_date, end_date, period, ins_type, doctor, option, weekday_list
    ):
        self.tab_statistics_business_income_list = (
            module_utils.get_statistics_business_income_list(
                self,
                self.database,
                self.system_settings,
                start_date,
        ...
        self.ui.tabWidget_statistics_business_income.addTab(
            self.tab_statistics_business_income_list, "執行業務所得統計"
        )
