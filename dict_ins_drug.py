...
from libs import (class_utils, dropbox_utils, nhi_utils, string_utils,
...
class DictInsDrug(QtWidgets.QMainWindow):
    ...
    def _read_medicine(self, medicine_name=None):
        ...
        if medicine_name is not None and medicine_name != '':
            medicine_name_script = f' AND medicine.MedicineName LIKE "%{medicine_name}%"'
    ...
    def _update_drug(self, medicine_type, file_name, url=None):
        title = '下載健保藥品更新檔'
        message = '<font size="5" color="red"><b>正在下載健保藥品更新檔, 請稍後...</b></font>'
    ...
    def _update_prescript(self):
        ...
        msg_box.setText("<font size='4' color='blue'><b>確定更新病歷內的處方健保碼資料?</b></font>")
